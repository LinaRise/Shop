...
public class OrdersCatSceneW {
    ...
    //метод для заполнения таблицы заказа из файла
    private void orderTableFillIn(){
        ...
        for(String line:lineArray) {
            String[] arrSplit = line.split("\\|",6);
            System.out.println(Arrays.toString(arrSplit));
            orderData.add(new Order(i,arrSplit[0],arrSplit[1],arrSplit[2],arrSplit[3],arrSplit[4],arrSplit[5]));
